...
# Create the data frame with the respective values
summary_data <- data.frame(
  Age = c(20.00, 27.00, 35.00, 35.15, 43.00, 50.00),
  Gender = c("0:762", "1:738", NA, NA, NA, NA),
  EducationLevel = c("1:307", "2:740", "3:317", "4:136", NA, NA),
  ExperienceYears = c(0.000, 4.000, 8.000, 7.694, 12.000, 15.000),
  PreviousCompanies = c(1.000, 2.000, 3.000, 3.002, 4.000, 5.000),
  DistanceFromCompany = c(1.031, 12.839, 25.502, 25.505, 37.738, 50.992),
  InterviewScore = c(0.000, 25.000, 52.000, 50.56, 75.000, 100.000),
  SkillScore = c(0.000, 25.75, 53.000, 51.12, 76.000, 100.000),
  PersonalityScore = c(0.000, 23.00, 49.00, 49.39, 76.00, 100.00),
  RecruitmentStrategy = c("1:445", "2:770", NA, "3:285", NA, NA),
  HiringDecision = c("0:1035", "1:465", NA, NA, NA, NA),
  Gender_name = c("Female:738", "Male:762", NA, NA, NA, NA),
  Hiring_name = c("Hired:465", "Not Hired:1035", NA, NA, NA, NA),
  Recruitment_name = c("Aggressive:445", "Moderate:770", "Conservative:285", NA, NA, NA),
  Education_name = c("Bachelor_1:307", "Bachelor_2:740", "Masters:317", "PhD:136", NA, NA),
  row.names = stats  # Assign the statistics as row names
)
...
boxplot(recruitment$Age, recruitment$ExperienceYears, recruitment$PreviousCompanies, 
        recruitment$DistanceFromCompany, recruitment$InterviewScore, 
        recruitment$SkillScore, recruitment$PersonalityScore,
        names=c("Age", "Experience Years", "Prev. Companies", 
                "Distance", "Interview Score", 
                "Skill Score", "Personality Score"),
        main="Boxplot of Multiple Variables",
        ylab="Values",
        col=c("lightblue","lightgreen","lightpink", "lightyellow", "lightgrey", "lightcoral", "lightcyan"),
        las=2)
